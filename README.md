# Tech Career Changer Syllabus

## What?
[Back to top](#tech-career-changer-syllabus)

This is my half-arsed attempt at producing an ['unofficial' syllabus](./syllabus.html) for anyone who is interested in writing code for a living, and has not done a computer science degree. I've tried to tailor it so its content would be useful for anyone who:
* Is _thinking about_ retraining (i.e. via self-study, a software development 'bootcamp', etc)
* Has already done that training
* Is relatively early in their career as a developer
...
There's no expectation that you tackle these in any particular order - feel free to pick and choose however seems right to you.
